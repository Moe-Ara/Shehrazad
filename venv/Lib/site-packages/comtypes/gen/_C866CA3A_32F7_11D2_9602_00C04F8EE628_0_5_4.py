...
__all__ = [
    'SPAR_Low', 'DISPID_SWFEChannels', 'SVEEndInputStream',
    'ISpeechGrammarRules', 'DISPID_SPRFirstElement',
    'DISPID_SASFreeBufferSpace', 'SDA_Two_Trailing_Spaces',
    'SPWORDTYPE', 'DISPID_SRCBookmark', 'DISPID_SABIEventBias',
    'SREStreamEnd', 'ISpeechPhraseElements',
    'DISPID_SPEAudioStreamOffset', 'SPPS_Verb', 'SPAR_High',
    'SPEI_TTS_PRIVATE', 'DISPID_SBSSeek', 'DISPID_SGRsDynamic',
    'SVP_18', 'SPPS_RESERVED1', 'DISPID_SRGDictationLoad',
    'DISPID_SABIMinNotification', 'SPCT_SUB_COMMAND',
    'SPRST_NUM_STATES', 'SAFT12kHz16BitStereo', 'SpeechLexiconType',
    'DISPID_SVEventInterests', 'DISPID_SLPLangId', 'SVPOver',
    'SAFTCCITT_ALaw_22kHzStereo', 'SPGS_EXCLUSIVE',
    'DISPID_SVSVisemeId', 'SAFT32kHz8BitMono', 'SPPROPERTYINFO',
    'DISPID_SRCEEnginePrivate', 'DISPID_SPEsItem',
    'DISPID_SpeechBaseStream', 'SPWORDPRONUNCIATION', 'SSTTWildcard',
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SVWaitUntilDone',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SPRST_ACTIVE_ALWAYS',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SPRuleName', 'SASPause',
    'IStream', 'SRADefaultToActive', 'SPWT_DISPLAY', 'SRTStandard',
    'ISpDataKey', 'DISPID_SpeechMMSysAudio', 'eLEXTYPE_PRIVATE10',
    'SpInprocRecognizer', 'DISPID_SWFEBlockAlign',
    'DISPID_SPPEngineConfidence', 'eLEXTYPE_USER',
    'SPEI_END_INPUT_STREAM', 'ISpeechAudioBufferInfo',
    'SDTPronunciation', 'SAFTGSM610_22kHzMono',
    'DISPID_SRGetPropertyString', 'DISPID_SPERequiredConfidence',
    ...
    'DISPID_SRCCreateResultFromMemory', 'ISpRecoCategory',
    'ISpeechPhraseReplacements', 'DISPID_SGRs_NewEnum', 'SPXRO_SML',
    'DISPID_SPAs_NewEnum', 'SPINTERFERENCE', 'SGSEnabled',
    'STCLocalServer', 'DISPID_SOTMatchesAttributes',
    'DISPID_SpeechLexiconWord', 'SPBO_TIME_UNITS', 'SP_VISEME_4',
    'SP_VISEME_15', 'SPVPRIORITY', 'SPDKL_DefaultLocation',
    ...
    'DISPID_SpeechPhraseBuilder', 'IInternetSecurityManager',
    'DISPID_SMSAMMHandle', 'ISpPhraseAlt', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SRCEPropertyNumberChange', 'SFTSREngine',
    'ISpRecognizer2', 'ISpeechXMLRecoResult',
    'DISPID_SASNonBlockingIO', 'SPRECOGNIZERSTATUS', 'DISPID_SLWWord',
    'DISPID_SRRSaveToMemory', 'SP_VISEME_11', 'SRARoot',
    'DISPID_SPIReplacements', 'ISpeechPhoneConverter',
    'SPAUDIOBUFFERINFO', 'ISpRecoContext2',
    'DISPID_SpeechGrammarRule', 'DISPID_SpeechPhraseReplacements',
    'Speech_Max_Word_Length', 'SVSFlagsAsync', 'SRSInactive',
    'SPEI_VISEME', 'SPAS_CLOSED', 'DISPID_SFSClose',
    'eWORDTYPE_ADDED', '_RemotableHandle',
    'SpeechCategoryRecoProfiles', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SPEDisplayAttributes', 'eLEXTYPE_PRIVATE11', 'SVP_4',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SRStatus',
    'ISpeechRecoResultTimes', 'SREAllEvents', 'SWTDeleted',
    'DISPID_SGRSAddSpecialTransition', 'SREBookmark',
    'DISPID_SLGetPronunciations', 'DISPID_SGRAttributes', 'SPPS_Noun',
    'DISPID_SPRuleParent', 'SSFMOpenForRead', 'SVSFIsFilename',
    'eLEXTYPE_PRIVATE20', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SPEI_MAX_SR', 'SPPS_NotOverriden', 'SAFTADPCM_8kHzStereo',
    'SP_VISEME_8', 'DISPID_SVSInputWordPosition', 'SRSEDone',
    'DISPID_SpeechRecoContext', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SAFGuid', 'SSFMCreateForWrite',
    'ISpeechLexiconPronunciations', 'SpeechTokenIdUserLexicon',
    'SP_VISEME_1', 'SAFT8kHz8BitStereo', 'SAFT16kHz16BitMono',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SLGetGenerationChange',
    'DISPID_SLPPartOfSpeech', 'DISPID_SpeechRecognizerStatus',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SPRsCount',
    'DISPID_SGRAddResource', 'DISPID_SVGetAudioOutputs',
    'SpeechAudioProperties', 'SPRECOSTATE', 'SPPS_Unknown',
    'Speech_Max_Pron_Length', 'SpeechAddRemoveWord', 'SRAImport',
    'DISPID_SRSCurrentStreamNumber', 'eLEXTYPE_PRIVATE14',
    'SPEI_RESERVED2', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SOTs_NewEnum', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SpeechCategoryAudioOut', 'SpeechTokenShellFolder',
    'DISPID_SVEWord', 'SPEI_SOUND_START', 'SPSHORTCUTPAIR',
    'SPEI_REQUEST_UI', 'SP_VISEME_9', 'LONG_PTR',
    'DISPID_SPANumberOfElementsInResult', 'SpeechCategoryRecognizers',
    'SPEI_FALSE_RECOGNITION', 'ISpeechLexicon',
    'DISPID_SGRSTPropertyName', 'SP_VISEME_20', 'SGRSTTDictation',
    'SPRULE', 'Speech_StreamPos_Asap', 'SpeechStreamFileMode',
    'DISPID_SPEEngineConfidence', 'SREStateChange', 'SDTLexicalForm',
    'SP_VISEME_7', 'ISpeechPhraseInfo', 'SpPhraseInfoBuilder',
    'SpeechRuleAttributes', 'DISPID_SPIEnginePrivateData',
    'SAFT44kHz8BitMono', 'DISPID_SRCPause', 'DISPID_SRRTimes',
    'SPEI_RESERVED1', 'SPAR_Medium', 'DISPID_SLWsCount',
    'SPWT_LEXICAL', 'WAVEFORMATEX', 'ISpNotifyTranslator',
    'SDKLLocalMachine', 'DISPID_SVAudioOutput', 'DISPID_SRCESoundEnd',
    'DISPID_SWFEAvgBytesPerSec', 'SpMMAudioEnum',
    'DISPID_SPIStartTime', 'SPSHT_NotOverriden', 'SPPS_Function',
    ...
    'SRAInterpreter', 'SpeechVisemeFeature',
    'SpeechDisplayAttributes', 'SVP_5', 'SPAS_STOP',
    'DISPID_SpeechLexiconWords', 'DISPID_SPIGetText', 'SPPHRASE',
    'DISPID_SGRSTPropertyValue', 'SLTUser', 'DISPID_SVAlertBoundary',
    'SAFTGSM610_8kHzMono', 'SPVPRI_ALERT',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SRSCurrentStreamPosition',
    'DISPID_SPPChildren', 'DISPID_SpeechPhraseProperties',
    'DISPID_SpeechLexicon', 'DISPID_SOTCreateInstance',
    'DISPID_SWFEExtraData', 'SAFT24kHz8BitMono', 'SREPrivate',
    'SPCT_SLEEP', 'DISPID_SBSWrite', 'DISPID_SPPConfidence',
    'SP_VISEME_12', 'SVP_6', 'eLEXTYPE_RESERVED4',
    'DISPID_SREmulateRecognition', 'SpWaveFormatEx', 'SREHypothesis',
    'SPINTERFERENCE_NOSIGNAL', 'ISpAudio', 'DISPID_SGRName',
    'DISPID_SLRemovePronunciation', 'SAFTADPCM_44kHzStereo',
    'DISPID_SDKSetBinaryValue', 'SPWORDPRONOUNCEABLE',
    'SAFTADPCM_22kHzMono', 'SAFT8kHz8BitMono', 'DISPID_SLPSymbolic',
    'DISPID_SPIRule', 'SpeechTokenContext',
    'ISpeechGrammarRuleStateTransition', 'ISpStreamFormat',
    'SpeechWordType', 'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SLWLangId',
    'SVP_15', 'DISPID_SRRSpeakAudio', 'SpCompressedLexicon',
    ...
    'DISPID_SRCVoicePurgeEvent', 'SVP_14', 'SVESentenceBoundary',
    'SREStreamStart', 'ISpRecoResult', 'DISPID_SGRsCommit',
    'DISPID_SVEBookmark', 'SAFT44kHz8BitStereo',
    'DISPID_SRIsUISupported', 'tagSPPROPERTYINFO',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SpShortcut',
    'DISPID_SPIProperties', 'DISPID_SVIsUISupported', 'SREAudioLevel',
    'ISpeechVoiceStatus', 'SITooFast', 'DISPID_SWFEFormatTag',
    'ISpeechPhraseRules', 'SDTAudio', 'SP_VISEME_13',
    'DISPID_SPPParent', 'SAFTNoAssignedFormat',
    'SDA_One_Trailing_Space', 'SECFIgnoreWidth',
    'SpeechGrammarTagDictation', 'SP_VISEME_18', 'DISPID_SRGetFormat',
    'DISPID_SGRSTWeight', 'SPCATEGORYTYPE', 'ISpeechMMSysAudio',
    'SGLexical', 'eLEXTYPE_RESERVED8', 'SpeechCategoryAppLexicons',
    'DISPID_SCSBaseStream', 'DISPID_SRGDictationUnload',
    'SPFM_OPEN_READWRITE', 'SAFTGSM610_11kHzMono',
    ...
    'DISPID_SpeechRecoContextEvents', 'SPAUDIOOPTIONS', 'SLTApp',
    'ISpRecoGrammar', 'DISPID_SVVoice', 'DISPID_SRAudioInput',
    'DISPID_SPRuleChildren', 'DISPID_SRSetPropertyString',
    'ISpeechObjectTokens', 'SpObjectTokenCategory', 'SGRSTTWord',
    'SpVoice', 'SpeechGrammarTagUnlimitedDictation',
    'SpeechPropertyComplexResponseSpeed',
    'DISPID_SRCreateRecoContext', 'SRSActive', 'SVEPhoneme',
    'DISPID_SpeechPhraseElement', 'DISPID_SpeechPhraseInfo',
    'SECHighConfidence', 'DISPID_SRSetPropertyNumber',
    'DISPID_SRSClsidEngine', 'SPAS_PAUSE', 'DISPID_SGRSTPropertyId',
    'SpFileStream', 'ISpXMLRecoResult', 'ISpMMSysAudio',
    'eLEXTYPE_PRIVATE2', 'SVSFPurgeBeforeSpeak', 'DISPID_SLPsCount',
    'SpeechTokenKeyFiles', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SPIAudioSizeBytes', 'SPWORDLIST',
    'DISPID_SpeechGrammarRules', 'IEnumString', 'SPSNotOverriden',
    'SAFT44kHz16BitMono', 'SAFT32kHz16BitMono', 'SPCONTEXTSTATE',
    'SGDSActiveWithAutoPause', 'SPLO_DYNAMIC', 'SPTEXTSELECTIONINFO',
    'SpeechAudioVolume', 'DISPID_SRGCmdLoadFromResource',
    'SpeechLoadOption', 'DISPID_SpeechPhraseRule',
    'DISPID_SRRAlternates', 'DISPID_SRCEAdaptation',
    'SRSActiveAlways', 'SVP_19', 'SVSFIsNotXML',
    'DISPID_SRRPhraseInfo', 'SpeechDictationTopicSpelling',
    'SAFTNonStandardFormat', 'SpeechUserTraining',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SDTRule',
    'DISPID_SRProfile', 'ISpeechAudio', 'DISPID_SpeechAudioFormat',
    'SPPS_LMA', 'SPPHRASEELEMENT', 'DISPID_SVEPhoneme',
    'DISPID_SDKSetLongValue', 'DISPID_SVGetAudioInputs',
    'DISPID_SWFESamplesPerSec', 'DISPID_SPPsCount', 'DISPID_SGRId',
    'DISPID_SGRsFindRule', 'SP_VISEME_3', 'SpeechTokenKeyUI',
    'eLEXTYPE_PRIVATE5', 'SpUnCompressedLexicon',
    'SAFT24kHz16BitStereo', 'SRSInactiveWithPurge',
    'DISPID_SRIsShared', 'DISPID_SPRuleId', 'SPWT_PRONUNCIATION',
    'DISPID_SRGReset', 'SAFT48kHz16BitStereo', 'SGRSTTTextBuffer',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SpeechAudio', 'SPBO_NONE',
    'SRATopLevel', 'DISPIDSPTSI_SelectionLength', 'DISPID_SPPName',
    'Speech_Default_Weight', 'DISPID_SRCEInterference',
    'SPFM_NUM_MODES', 'ISequentialStream', 'SREPhraseStart',
    'SECFIgnoreKanaType', 'DISPID_SGRSAddRuleTransition',
    'DISPID_SPCPhoneToId', 'SP_VISEME_6', 'SECFNoSpecialChars',
    'ISpNotifySink', 'DISPID_SPIEngineId', 'SP_VISEME_19',
    'ISpeechRecognizerStatus', 'DISPID_SRSAudioStatus',
    'DISPID_SPRsItem', 'SPPS_Modifier', 'IEnumSpObjectTokens',
    'SAFT11kHz16BitStereo', 'DISPID_SLPType', 'ISpeechPhraseElement',
    'SLODynamic', 'DISPID_SPIElements', 'SpPhoneConverter',
    'DISPID_SPEAudioSizeTime', 'DISPID_SVSInputSentenceLength',
    'DISPID_SMSALineId', 'SRSEIsSpeaking', 'ISpStream', 'SPVPRI_OVER',
    'SVSFParseSapi', 'DISPID_SRRAudio', 'DISPID_SVSInputWordLength',
    'SP_VISEME_10', 'ISpRecognizer', 'SRTExtendableParse',
    'DISPID_SRRTTickCount', 'SGPronounciation',
    'SpeechRegistryUserRoot', 'DISPID_SMSSetData',
    'DISPID_SDKEnumKeys', 'SpeechAudioFormatGUIDWave',
    'SpeechDiscardType', 'SRAExport', 'ISpeechPhraseProperties',
    'SRAONone', 'DISPID_SRRSetTextFeedback', 'SPRS_INACTIVE',
    'SAFT11kHz16BitMono', 'SAFT12kHz8BitMono', 'SPEI_ADAPTATION',
    'SINoise', 'DISPID_SPILanguageId', 'SPWAVEFORMATTYPE',
    'SPEI_PROPERTY_NUM_CHANGE', 'SVP_11', 'ISpeechRecoGrammar',
    'DISPID_SPPId', 'DISPID_SpeechWaveFormatEx', 'DISPID_SGRsCount',
    'DISPID_SLGenerationId', 'SpeechEngineProperties',
    'SRAORetainAudio', 'SPXRO_Alternates_SML', 'DISPID_SRRecognizer',
    'SPSTREAMFORMATTYPE', 'DISPID_SLWs_NewEnum', 'DISPID_SVEViseme',
    'SGSDisabled', 'SP_VISEME_14', 'SSFMCreate',
    'DISPID_SDKGetBinaryValue', 'ISpeechRecoContext', 'SRCS_Disabled',
    'DISPID_SRCRetainedAudioFormat', 'ISpRecoContext', 'SPSLMA',
    'ISpeechBaseStream', 'DISPID_SPRText', 'SPSSuppressWord',
    'tagSTATSTG', 'SPEI_RECO_STATE_CHANGE', 'SP_VISEME_16',
    'DISPID_SLRemovePronunciationByPhoneIds', 'DISPID_SRGCommit',
    'DISPID_SPPsItem', '_ISpeechVoiceEvents', 'SpeechInterference',
    ...
    'SpSharedRecoContext', 'DISPID_SDKDeleteKey', 'SPGS_DISABLED',
    'DISPID_SMSGetData', 'SPFILEMODE', 'SpeechAudioFormatType',
    'DISPID_SDKOpenKey', 'DISPID_SVPriority', 'DISPID_SOTCategory',
    'SVEAllEvents', 'SVSFPersistXML', 'DISPID_SRRRecoContext',
    'SASClosed', 'DISPID_SRGetPropertyNumber', 'SPRST_ACTIVE',
    'SAFTTrueSpeech_8kHz1BitMono', 'SAFTCCITT_uLaw_11kHzMono',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SVP_8',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SVSpeakStream',
    'DISPID_SGRSTransitions', 'DISPID_SLWsItem', 'SDKLCurrentUser',
    'SpMemoryStream', 'SPSNoun', 'SPPS_Interjection',
    'SAFTADPCM_8kHzMono', 'SDKLDefaultLocation',
    'SpeechTokenKeyAttributes', 'eLEXTYPE_PRIVATE1',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SLPsItem', 'SINoSignal',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SRGId',
    'DISPID_SPIAudioStreamPosition', 'SPRS_ACTIVE',
    'SPEI_PROPERTY_STRING_CHANGE', 'SAFT12kHz8BitStereo',
    'DISPID_SPIRetainedSizeBytes', 'SpeechCategoryVoices', 'SPWORD',
    'SVSFParseSsml', 'DISPID_SPRuleEngineConfidence',
    'SPSERIALIZEDRESULT', 'eWORDTYPE_DELETED',
    'DISPID_SRGCmdLoadFromMemory', 'SPAO_RETAIN_AUDIO',
    'SAFT32kHz8BitStereo', 'DISPID_SOTSetId', 'SPXMLRESULTOPTIONS',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SRRTStreamTime',
    'DISPID_SAFSetWaveFormatEx', 'SPPHRASEPROPERTY', 'DISPID_SRState',
    'DISPID_SLWType', 'eLEXTYPE_PRIVATE17', 'DISPID_SOTId',
    'DISPID_SpeechPhraseElements', 'DISPID_SGRSTRule',
    'DISPID_SRCSetAdaptationData', 'SAFT48kHz8BitStereo',
    'DISPID_SLGetWords', 'SSSPTRelativeToEnd',
    'DISPID_SPEAudioTimeOffset', 'SAFT22kHz8BitStereo',
    'eLEXTYPE_PRIVATE8', 'SPAUDIOSTATE', 'SPINTERFERENCE_TOOQUIET',
    'SVP_20', 'DISPID_SPEAudioSizeBytes',
    ...
    'SREInterference', 'SpeechAudioState',
    'SpeechPropertyAdaptationOn', 'SpCustomStream', 'SPEVENTENUM',
    'eLEXTYPE_PRIVATE16', 'DISPID_SOTDisplayUI', 'SVEAudioLevel',
    'SP_VISEME_2', 'SDTAll', 'DISPID_SRCERecognizerStateChange',
    'SpeechRecoEvents', 'SpeechEngineConfidence',
    'DISPIDSPTSI_SelectionOffset', 'SPDKL_CurrentUser',
    'SPPHRASEREPLACEMENT', 'SVF_Stressed', 'DISPID_SPRs_NewEnum',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SRRTLength',
    'SPEI_RECOGNITION', 'DISPID_SAFGetWaveFormatEx', 'SSTTDictation',
    'SGDSActiveUserDelimited', 'DISPID_SRCResume', 'SPVISEMES',
    'ISpEventSource', 'SPSVerb', 'eLEXTYPE_RESERVED9',
    'DISPID_SOTIsUISupported', 'DISPID_SRGetRecognizers',
    'DISPID_SBSFormat', 'SpeechGrammarWordType', 'ISpShortcut',
    'SpeechWordPronounceable', 'DISPID_SRGRules',
    'SDA_No_Trailing_Space', 'SVP_3', 'SINone', 'SpObjectToken',
    'SVSFVoiceMask', 'SpeechCategoryAudioIn', 'eLEXTYPE_PRIVATE7',
    'SpNotifyTranslator', 'DISPID_SpeechPhoneConverter',
    '_ISpeechRecoContextEvents', 'ISpeechResourceLoader',
    'SRESoundEnd', 'DISPID_SpeechPhraseRules',
    'DISPID_SVSRunningState', 'DISPID_SGRsCommitAndSave',
    'SAFT48kHz8BitMono', 'SPFM_CREATE_ALWAYS', 'SPWF_INPUT',
    'SAFTCCITT_ALaw_22kHzMono', 'ISpPhoneticAlphabetConverter',
    'SVP_17', 'SITooQuiet', 'SPSUnknown', 'DISPID_SRAudioInputStream',
    'SWPUnknownWordUnpronounceable', 'DISPID_SVEStreamStart',
    'DISPID_SPPValue', 'SWPKnownWordPronounceable',
    'SpeechPropertyResponseSpeed', 'SPPARTOFSPEECH', 'ISpProperties',
    'ISpObjectWithToken', 'SVEWordBoundary', 'SPEI_START_SR_STREAM',
    'SpNullPhoneConverter', 'DISPID_SRCVoice',
    'DISPID_SRCERecognitionForOtherContext', 'SPEI_MIN_TTS',
    'SPWF_SRENGINE', 'SGDisplay', 'DISPID_SPISaveToMemory',
    'DISPID_SpeechDataKey', 'DISPID_SVEAudioLevel',
    'DISPID_SRCERequestUI', 'ISpeechCustomStream', 'SPBINARYGRAMMAR',
    'eLEXTYPE_RESERVED6', 'DISPID_SVResume', 'SPEI_VOICE_CHANGE',
    'SPRST_INACTIVE_WITH_PURGE', 'SPDATAKEYLOCATION',
    'SPRECORESULTTIMES', 'SPEI_INTERFERENCE',
    'DISPID_SRCCmdMaxAlternates', 'SPSHT_Unknown', 'DISPID_SAFType',
    'ISpeechRecoResult', 'ISpeechPhraseInfoBuilder', 'SRADynamic',
    'SVP_0', 'eLEXTYPE_RESERVED10', 'SAFTADPCM_11kHzStereo',
    'SPCS_DISABLED', 'ISpVoice', 'SAFTCCITT_ALaw_44kHzStereo',
    'SBOPause', 'DISPID_SBSRead', 'SpStream',
    'DISPID_SOTGetAttribute', 'DISPID_SpeechRecognizer', 'UINT_PTR',
    'SAFT16kHz16BitStereo', 'ISpSerializeState', 'SVSFDefault',
    'ISpNotifySource', 'SRERecognition', 'eLEXTYPE_VENDORLEXICON',
    'SP_VISEME_0', 'SPSHT_EMAIL', 'ISpeechRecognizer',
    'SAFT8kHz16BitMono', 'SPPS_Noncontent', 'SPVPRI_NORMAL',
    'DISPIDSPRG', 'SVEBookmark', 'SGRSTTEpsilon', 'SPLOADOPTIONS',
    'SPEI_SR_PRIVATE', 'DISPID_SpeechVoiceEvent', 'SPEI_SOUND_END',
    'SpMMAudioIn', 'DISPID_SVVolume', 'ISpeechObjectTokenCategory',
    'SAFT44kHz16BitStereo', 'DISPID_SVSyncronousSpeakTimeout',
    'SVSFNLPMask', 'ISpeechPhraseAlternates', 'SPRECOCONTEXTSTATUS',
    'IInternetSecurityMgrSite', 'SAFTCCITT_uLaw_8kHzStereo',
    'SAFT22kHz16BitStereo', 'SVP_16', 'ISpeechWaveFormatEx',
    'SP_VISEME_17', 'SDTProperty', 'DISPID_SpeechFileStream',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SAFT16kHz8BitStereo', 'DISPID_SpeechPhraseAlternates',
    'SPEVENTSOURCEINFO', 'SECFEmulateResult', 'SpeechDataKeyLocation',
    'DISPID_SRCEFalseRecognition', 'SPEI_SR_BOOKMARK',
    'DISPID_SPCIdToPhone', 'DISPID_SRCState', 'ISpeechPhraseRule',
    'SPBOOKMARKOPTIONS', 'ISpEventSink', 'SGDSInactive',
    ...
    'SpeechMicTraining', 'SpeechRetainedAudioOptions',
    'DISPID_SPPNumberOfElements', 'DISPID_SRCRecognizer',
    'SDTReplacement', 'DISPID_SPRDisplayAttributes',
    'STCRemoteServer', 'DISPID_SOTDataKey', 'SAFTText',
    'SPPS_RESERVED4', 'DISPID_SADefaultFormat',
    'SPINTERFERENCE_NOISE', 'ISpeechFileStream', 'DISPID_SOTCSetId',
    'SPEI_RESERVED5', 'SPGS_ENABLED', 'SVP_13',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SDKSetStringValue',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SASCurrentSeekPosition',
    'eLEXTYPE_PRIVATE3', 'DISPID_SRCEStartStream', 'SLOStatic',
    ...
    'DISPID_SRGCmdLoadFromObject', 'SpeechRecognizerState',
    ...
    'SPPS_SuppressWord', 'SpeechVisemeType', 'SpAudioFormat', 'SVP_1',
    'ISpeechVoice', 'STCInprocServer', 'SPEI_MIN_SR',
    'SPADAPTATIONRELEVANCE', 'DISPID_SPRuleConfidence', 'SFTInput',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SVEEnginePrivate',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SPEs_NewEnum',
    'SPGRAMMARSTATE', 'eLEXTYPE_PRIVATE15', 'STSF_AppData',
    'DISPID_SVGetProfiles', 'SRTSMLTimeout', 'DISPID_SPPs_NewEnum',
    'SVSFUnusedFlags', 'SpeechGrammarState', 'ISpeechGrammarRule',
    'SREAdaptation', 'SREPropertyNumChange',
    'DISPID_SRRTOffsetFromStart', 'ISpLexicon', 'DISPID_SASState',
    'SGSExclusive', 'SPEI_RESERVED6', 'SRERecoOtherContext',
    'ISpeechRecoResultDispatch', 'DISPID_SpeechRecoResult',
    'SRERequestUI', 'SASRun', 'SWPUnknownWordPronounceable',
    'SAFT16kHz8BitMono', 'SPVOICESTATUS', 'SPCT_SUB_DICTATION',
    'SPEI_WORD_BOUNDARY', 'DISPIDSPTSI', 'SVP_9',
    'DISPID_SGRInitialState', 'DISPID_SVRate', 'STCInprocHandler',
    'DISPID_SPRulesCount', 'DISPID_SPPFirstElement',
    'SVEStartInputStream', 'SVP_12', 'SPRULESTATE',
    'DISPID_SRCRetainedAudio', 'DISPID_SGRClear', 'DISPID_SOTRemove',
    'SpInProcRecoContext', 'SECFIgnoreCase', 'SPINTERFERENCE_TOOLOUD',
    'SpeechAudioFormatGUIDText', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SWFEBitsPerSample', 'SSSPTRelativeToStart',
    'DISPID_SVSLastResult', 'SPAUDIOSTATUS', 'DISPID_SVEVoiceChange',
    'SpeechVoiceSpeakFlags', 'SpeechBookmarkOptions', 'SP_VISEME_5',
    'SECFDefault', 'DISPID_SPRulesItem', 'SWTAdded',
    'ISpeechRecoResult2', 'SDA_Consume_Leading_Spaces', 'SVP_21',
    'SPEI_TTS_BOOKMARK', 'DISPID_SPCLangId', 'DISPID_SRDisplayUI',
    'SPCT_DICTATION', 'DISPID_SpeechGrammarRuleStateTransition',
    'SGLexicalNoSpecialChars', 'DISPID_SpeechMemoryStream',
    'SAFT22kHz8BitMono', 'SPSFunction', 'SAFTCCITT_uLaw_11kHzStereo',
    'SPSInterjection', 'SVEPrivate', 'DISPID_SPARecoResult',
    'SGRSTTWildcard', 'DISPID_SLWPronunciations',
    'DISPID_SRCEAudioLevel', 'SPEI_UNDEFINED',
    ...
    'SpeechPropertyResourceUsage', 'DISPID_SVSPhonemeId',
    'SpeechCategoryPhoneConverters', 'SpeechPartOfSpeech',
    'DISPID_SpeechObjectTokens', 'DISPID_SVSLastStreamNumberQueued',
    'SASStop', 'DISPID_SpeechGrammarRuleState', 'SpeechVoicePriority',
    'SpeechSpecialTransitionType', 'SAFTCCITT_ALaw_44kHzMono',
    'SpSharedRecognizer', 'SDTDisplayText',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SOTCGetDataKey',
    'ISpeechAudioStatus', 'DISPID_SRRGetXMLResult',
    'DISPID_SABufferInfo', 'ISpeechLexiconWord',
    'DISPID_SPAPhraseInfo', 'DISPID_SOTsCount', 'SPDKL_LocalMachine',
    'SPEI_HYPOTHESIS', 'SpeechVoiceEvents',
    'DISPID_SVAudioOutputStream', 'SPPS_RESERVED3',
    'DISPID_SpeechLexiconProns', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SRCERecognition', 'SP_VISEME_21', 'ISpRecoGrammar2',
    'DISPID_SGRSRule', 'ISpeechTextSelectionInformation',
    'DISPID_SRGSetWordSequenceData', 'SpeechRecognitionType',
    'eLEXTYPE_PRIVATE6', 'SECLowConfidence', 'SRESoundStart',
    'DISPID_SGRAddState', 'eLEXTYPE_PRIVATE4',
    'DISPID_SRGCmdSetRuleState', 'SITooLoud', 'SDKLCurrentConfig',
    'SAFT11kHz8BitMono', 'SVEViseme', 'SVSFIsXML', 'SPBO_AHEAD',
    'DISPID_SPIGrammarId', 'SPINTERFERENCE_NONE',
    'SAFTCCITT_ALaw_8kHzStereo', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SVPause', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SRTEmulated', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'ISpStreamFormatConverter', 'SAFTADPCM_22kHzStereo',
    'SVSFParseAutodetect', 'DISPID_SPAStartElementInResult',
    'tagSPTEXTSELECTIONINFO', 'SVP_2', 'SPAS_RUN', 'SpeechRuleState',
    'DISPID_SGRSTText', 'eLEXTYPE_PRIVATE19', 'DISPID_SAStatus',
    'DISPID_SpeechAudioStatus', 'DISPID_SABufferNotifySize',
    'SAFT24kHz16BitMono', 'SPEI_MAX_TTS', 'SPSHT_OTHER',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SVEStreamEnd', 'DISPID_SPAsItem',
    'SRTAutopause', 'DISPID_SVDisplayUI', 'SpeechFormatType',
    'DISPID_SpeechRecoResult2', 'DISPID_SVSpeak',
    'SPSEMANTICERRORINFO', 'ISpPhoneConverter',
    'DISPID_SRRAudioFormat', 'eLEXTYPE_PRIVATE12',
    ...
    'SAFTExtendedAudioFormat', 'DISPID_SVSkip', 'DISPID_SOTCId',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SpeechCustomStream',
    'SpeechRecoContextState', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SRCEEndStream', 'SPSMF_UPS', 'DISPID_SPACommit',
    'eLEXTYPE_PRIVATE13', 'SPEVENT', 'SAFTADPCM_11kHzMono',
    'DISPID_SOTCDefault', 'SPBO_PAUSE', 'DISPID_SGRSTsCount',
    'DISPID_SPEActualConfidence', 'DISPID_SDKGetlongValue',
    'DISPID_SPIAudioSizeTime', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SpMMAudioOut', 'SPINTERFERENCE_TOOFAST',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SASetState', 'SVP_7',
    'DISPID_SRGCmdSetRuleIdState', 'SpeechAllElements',
    'DISPID_SpeechVoice', 'DISPID_SPEsCount',
    'DISPID_SVSInputSentencePosition', 'ISpeechPhraseReplacement',
    'SPSHORTCUTTYPE', 'DISPID_SRGIsPronounceable',
    'SAFT48kHz16BitMono', 'SpStreamFormatConverter',
    'ISpeechGrammarRuleState', 'SVPNormal', 'SPEI_PHRASE_START',
    'DISPID_SpeechPhraseAlternate', 'ISpResourceManager',
    'SPEI_PHONEME', 'eLEXTYPE_APP', 'eLEXTYPE_RESERVED7',
    'SPSHORTCUTPAIRLIST', 'DISPID_SPIGetDisplayAttributes',
    'SPINTERFERENCE_TOOSLOW', 'ISpPhrase', 'SAFTGSM610_44kHzMono',
    'SPSModifier', 'DISPID_SPRNumberOfElements', 'SITooSlow',
    'SAFTDefault', 'SAFT12kHz16BitMono', 'DISPID_SPRules_NewEnum',
    'SPINTERFERENCE_LATENCY_WARNING', 'SpLexicon',
    'DISPID_SDKDeleteValue', 'SVF_Emphasis', 'ISpeechAudioFormat',
    'DISPID_SRCAudioInInterferenceStatus', 'SVF_None',
    'SpeechRunState', 'DISPID_SAVolume', 'SPAR_Unknown',
    'DISPID_SPEDisplayText', 'ISpGrammarBuilder', 'SPFM_CREATE',
    'SPPHRASERULE', 'DISPID_SpeechPhraseProperty',
    'ISpeechLexiconPronunciation', 'DISPID_SLPs_NewEnum',
    'DISPID_SRCESoundStart', 'ISpRecognizer3', 'SAFT24kHz8BitStereo',
    'SDTAlternates', 'DISPID_SOTsItem',
    'DISPID_SOTGetStorageFileName', 'DISPID_SPRuleFirstElement',
    'SECNormalConfidence', 'SPGRAMMARWORDTYPE', 'DISPID_SLPPhoneIds',
    'SRTReSent', 'DISPID_SPEPronunciation', 'eLEXTYPE_PRIVATE18',
    'eLEXTYPE_PRIVATE9', 'ISpeechDataKey', 'SSFMOpenReadWrite',
    'DISPID_SVGetVoices', 'ISpeechLexiconWords', 'ISpObjectToken',
    'SVP_10', 'STSF_FlagCreate', 'SPSEMANTICFORMAT', 'SVSFParseMask',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SRCEHypothesis',
    'DISPID_SVStatus', 'DISPID_SDKGetStringValue', 'STCAll',
    'SBONone', 'DISPID_SDKCreateKey', 'DISPID_SRGRecoContext',
    'DISPID_SRGState', 'DISPID_SpeechAudioBufferInfo',
    'SPPS_RESERVED2', 'SSTTTextBuffer', 'SRCS_Enabled',
    'ISpeechMemoryStream', 'SpeechPropertyNormalConfidenceThreshold',
    'SAFT22kHz16BitMono', 'DISPID_SOTRemoveStorageFileName',
    'DISPID_SGRSAddWordTransition', 'DISPID_SpeechRecoResultTimes',
    'SVEVoiceChange', 'SVPAlert', 'ISpeechObjectToken',
    'DISPID_SGRsAdd', 'DISPID_SRGDictationSetState', 'SPLO_STATIC',
    'SPEI_RESERVED3', 'DISPID_SFSOpen', 'SPEI_END_SR_STREAM',
    'SAFTCCITT_uLaw_22kHzMono', 'SPFM_OPEN_READONLY',
    'SpeechTokenValueCLSID', 'SAFTCCITT_uLaw_8kHzMono'
]

_check_version('1.1.14', 1652407052.675980)
